...
if [ -z "$NO_DOCKER_IMAGE" ]; then
  ...
  # tagging the images...
  sudo docker tag pushsoft/codebase 10.0.35.16:5000/docbase:250322 || exit 1
  sudo docker tag pushsoft/codecore 10.0.35.16:5000/doccore:250322 || exit 1
  sudo docker tag pushsoft/code 10.0.35.16:5000/doc:250322 || exit 1
  sudo docker tag 10.0.35.16:5000/docbase:250322 10.0.35.16:5000/docbase:latest || exit 1
  sudo docker tag 10.0.35.16:5000/doccore:250322 10.0.35.16:5000/doccore:latest || exit 1
  sudo docker tag 10.0.35.16:5000/doc:250322 10.0.35.16:5000/doc:latest || exit 1
  # 推送doc
  sudo docker push 10.0.35.16:5000/docbase:250322 || exit 1
  sudo docker push 10.0.35.16:5000/docbase || exit 1
  sudo docker push 10.0.35.16:5000/doccore:250322 || exit 1
  sudo docker push 10.0.35.16:5000/doccore || exit 1
  sudo docker push 10.0.35.16:5000/doc:250322 || exit 1
